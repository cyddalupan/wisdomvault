...
def instruction():
    return "\nIMPORTANT AND PRIORITy: Please collect and ensure the user provides their mobile number, gender, area, and birthday. This information is mandatory, and its importance should be communicated clearly and respectfully. Once obtained, trigger the `save_user_info` function."
