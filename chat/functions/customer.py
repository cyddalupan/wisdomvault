...
def instruction(facebook_page_instance, target_row=None):
    ...
    marketing_message = "Promote our product or business proactively and engage the user to keep the conversation going, rather than just responding. If you do know what to say on the most recent message, never assume or invent, just trigger the help function."
